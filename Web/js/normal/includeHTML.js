...
function fnHead(num){       // 头部html  
	...
	/*<a class="AppDownload" href="javascript:"><span class="download">手机App</span><div class="QRcode">\
		<div class="alignLeft">\
		    <img src="'+url+'/img/App.png" alt="App" />\
	...
	var headContent = '<div class="wrap">\
		<div class="topBar clear">\
			<div class="topLeft">\
				<span>服务热线：</span><strong>400-861-5058</strong><span>服务时间：每工作日9:30-17:30</span><span class="msg">市场有风险，投资需谨慎！</span>\
			</div>\
			<div class="topRight">\
				<span id="loginStatus" class="loginStatus"></span>\
				<a class="login" href="'+url+'/html/zyfyLogin.html" id="userName" >立即登录</a>\
				<a class="register" href="'+url+'/html/regsiter.html" id="userOut">个人注册</a>\
				<a class="register company" id="companyLink" href="'+url+'/html/companyRegsiter.html">企业注册</a>\
				<a href="'+url+'/html/activityZonePage/Introduction.html">关于我们</a>\
				<a href="'+url+'/html/activityZonePage/question.html">帮助中心</a>\
			</div>\
		</div>\
	</div>\
	<div class="logBar clear">\
		<a href="'+url+'/index.html"><img class="log" src="'+url+'/img/log.png" alt="log" /></a>\
		<ul class="headNav">\
			<li class="'+arr[1].a+'" >\
				<a href="'+url+'/index.html">首页</a>\
			</li>\
			<li class="'+arr[2].a+'" >\
				<a href="'+url+'/html/investment.html">我要投资</a>\
			</li>\
			<li class="'+arr[3].a+'" >\
				<a class="myAccount" heft="'+url+'/html/myAccount.html">我的账户</a>\
			</li>\
			<li class="'+arr[4].a+'" >\
				<a href="'+url+'/html/activityZonePage/safetyControl.html">安全保障</a>\
			</li>\
			<li class="'+arr[5].a+'" >\
				<a href="'+url+'/html/newPeople.html">新手指引</a>\
			</li>\
		</ul>\
		<script type="text/javascript" src="https:\/\/webchat.7moor.com/javascripts/7moorInit.js?accessId=cca62210-afe9-11e7-aca7-d9a8fc5ef5d8&autoShow=true" async="async" ></script>\
	</div>';
	        ...
	        <div class="w1000">\
	                <div class="footerTop clear">\
	                    <ul class="left clear webMap">\
	                        <li class="left">\
	                            <h4>关于我们</h4>\
	                            <p><a href="'+url+'/html/activityZonePage/Introduction.html">公司介绍</a></p>\
	                            <p><a href="'+url+'/html/activityZonePage/team.html">运营团队</a></p>\
	                            <p><a href="'+url+'/html/activityZonePage/contactUs.html">联系我们</a></p>\
	                        </li>\
	                        <li class="left">\
	                            <h4>法律保障</h4>\
	                            <p><a href="'+url+'/html/activityZonePage/policiesAndRegulations.html">政策法规</a></p>\
	                            <p><a href="'+url+'/html/activityZonePage/safetyControl.html">安全保障</a></p>\
	                            <p><a href="'+url+'/html/activityZonePage/legalStatement.html">法律声明</a></p>\
	                        </li>\
	                        <li class="left">\
	                            <h4>常见问题</h4>\
	                            <p><a href="'+url+'/html/activityZonePage/question.html">关于投资</a></p>\
	                            <p><a href="'+url+'/html/activityZonePage/question.html">关于借款</a></p>\
	                            <p><a href="'+url+'/html/activityZonePage/question.html">充值提现</a></p>\
	                        </li>\
	                    </ul>\
	                    <ul class="left info">\
	                        <li class="tel">400-861-5058</li>\
	                        <li class="email"><a href="mailto:service@zhongyangcf.com">service@zhongyangcf.com</a></li>\
	                    </ul>\
	                    <div class="weixin left clear">\
	                        
	                        <div class="alignLeft">\
	                            <img src="'+url+'/img/weixin.jpg" alt="Android" />\
	                ...
	                <div class="footerBottom">\
	                    <p class="firs">\
	                        ...
	                        <span class="splitor">|</span>\
	                        <a href="https://www.xib.com.cn/" target="_blank">厦门国际银行</a>\
	                        <span class="splitor">|</span>\
	                    ...
	                    <p class="las"><a href="https://seal.wosign.com/Signature/Profiles/bp/CN/b1e79843aaba4d52a0f4ef3078d1f3ea.htm?ref=aHR0cHM6Ly93d3cuenVveW91ZnkuY29t"  target="_blank" ><img src="'+url+'/img/footer_bg.jpg"/></a>\
	                        <a id="___szfw_logo___" href="https://credit.szfw.org/CX20150714010321370130.html" target="_blank" ><img src="'+url+'/img/chengxin.png" /></a>\
	                        <a href="http://www.itrust.org.cn/home/index/itrust_certifi/wm/1918794358.html"  target="_blank" ><img src="'+url+'/img/busnessP.png"/></a>\
	                    </p>\
	                </div>\
	        </div>\
	</div>';
...
function fnRigthFloat(){    // 右下角浮动窗，包括计算器（html）  
	var floatContent = '<ul class="floatWindow">\
		...
		<li class="weixin"><span>关注微信</span><img src="'+url+'/img/weixin.jpg" alt="微信二维码" /></li>\
